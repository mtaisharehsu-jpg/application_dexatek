...
#if defined(PRIVATE_CMD)
#if defined(P2P_PRIVATE_CMD)
...
#if defined(ANDROID_P2P) || (defined(PRIVATE_CMD) && defined(P2P_PRIVATE_CMD))
					     ...
					     struct external_auth *params)
{
	...
	snprintf((char *)data, sizeof(struct external_auth), "EXT_AUTH_STATUS ");
...
#endif /* ANDROID_P2P || PRIVATE_CMD */
#if defined(ANDROID) || defined(PRIVATE_CMD)
#ifndef ANDROID_LIB_STUB
	.driver_cmd = wpa_driver_nl80211_driver_cmd,
#endif /* !ANDROID_LIB_STUB */
#endif /* ANDROID || PRIVATE_CMD */
