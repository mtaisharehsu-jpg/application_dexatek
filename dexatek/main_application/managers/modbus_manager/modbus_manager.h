...
typedef enum {
    ...
    // v021 相容性別名 (不含 _V 後綴)
    MODBUS_ADDRESS_AD74416H_CH_A_VOLTAGE_OUTPUT = 37,
    MODBUS_ADDRESS_AD74416H_CH_B_VOLTAGE_OUTPUT = 39,
    MODBUS_ADDRESS_AD74416H_CH_C_VOLTAGE_OUTPUT = 41,
    MODBUS_ADDRESS_AD74416H_CH_D_VOLTAGE_OUTPUT = 43,
...
// v021 新增: 產品序列號暫存器位址定義
typedef enum {
	MODBUS_ADDRESS_PRODUCT_SN_0 = 5071,
    MODBUS_ADDRESS_PRODUCT_SN_1 = 5072,
    MODBUS_ADDRESS_PRODUCT_SN_2 = 5073,
    MODBUS_ADDRESS_PRODUCT_SN_3 = 5074,
    MODBUS_ADDRESS_PRODUCT_SN_4 = 5075,
    MODBUS_ADDRESS_PRODUCT_SN_5 = 5076,
    MODBUS_ADDRESS_PRODUCT_SN_6 = 5077,
    MODBUS_ADDRESS_PRODUCT_SN_7 = 5078,
} MODBUS_ADDRESS_PRODUCT_SN_TABLE;
...
static const uint16_t _MODBUS_DATA_KEEP_LIST[] = {
    ...
    5056,
    2801,
    MODBUS_ADDRESS_PRODUCT_SN_0,
    MODBUS_ADDRESS_PRODUCT_SN_1,
    MODBUS_ADDRESS_PRODUCT_SN_2,
    MODBUS_ADDRESS_PRODUCT_SN_3,
    MODBUS_ADDRESS_PRODUCT_SN_4,
    MODBUS_ADDRESS_PRODUCT_SN_5,
    MODBUS_ADDRESS_PRODUCT_SN_6,
    MODBUS_ADDRESS_PRODUCT_SN_7,
    5081,
    6001,
    6002,
    6003,
