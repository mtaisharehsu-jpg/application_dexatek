...
#define REG_T1_TEMP_STR "T1"   // 414554 - 溫度感測器T1讀值
#define REG_T2_TEMP_STR "T2"   // 414554 - 溫度感測器T2讀值
#define REG_T3_TEMP_STR "T3"   // 414554 - 溫度感測器T3讀值
#define REG_T4_TEMP_STR "T4"   // 414554 - 溫度感測器T4讀值
#define REG_T5_TEMP_STR "T5"   // 414554 - 溫度感測器T5讀值
#define REG_T6_TEMP_STR "T6"   // 414554 - 溫度感測器T6讀值
#define REG_T4_TEMP_STR "T7"   // 414554 - 溫度感測器T7讀值
#define REG_T5_TEMP_STR "T8"   // 414554 - 溫度感測器T8讀值
#define REG_T6_TEMP_STR "T9"   // 414554 - 溫度感測器T9讀值
...
#define REG_P4_PRESSURE_STR "P2"   // 42083 - 壓力感測器P4讀值
#define REG_P2_PRESSURE_STR "P3"   // 42084 - 壓力感測器P2讀值
#define REG_P3_PRESSURE_STR "P4"   // 42085 - 壓力感測器P3讀值
#define REG_P1_PRESSURE_STR "P5"   // 42086 - 壓力感測器P1讀值
#define REG_P4_PRESSURE_STR "P6"   // 42087 - 壓力感測器P4讀值
#define REG_P2_PRESSURE_STR "P7"   // 42088 - 壓力感測器P2讀值
#define REG_P3_PRESSURE_STR "P8"   // 42089 - 壓力感測器P3讀值
#define REG_P9_PRESSURE_STR "P9"   // 42090 - 壓力感測器P9讀值
#define REG_P10_PRESSURE_STR "P10" // 42091 - 壓力感測器P10讀值
...
/* 控制模式暫存器 */
#define REG_TEMP_CONTROL_MODE_STR "TEMP_CONTROL_MODE"   // 45020 - 溫度控制模式（自動/手動）
...
#define REG_PUMP2_CONTROL_STR "PUMP2_CONTROL" // 411103 - 幫浦2控制輸出
#define REG_PUMP3_CONTROL_STR "PUMP3_CONTROL" // 411105 - 幫浦3控制輸出

/* 閥門控制暫存器 */
#define REG_VALVE_SETPOINT_STR "VALVE_SETPOINT" // 411147 - 閥門開度設定值（%）
#define REG_VALVE_ACTUAL_STR "VALVE_ACTUAL"     // 411161 - 閥門實際開度回饋值（%）
