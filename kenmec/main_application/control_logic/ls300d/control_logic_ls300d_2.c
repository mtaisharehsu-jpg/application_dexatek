/*
 * control_logic_ls300d_2_m_v01.c - LS80 壓力差控制邏輯（手動替換版本 v01）
 *
 * ============================================================================
 * 【版本說明】
 * ============================================================================
 * - 檔案名稱：control_logic_ls300d_2_m_v01.c（手動替換版本）
 * - 替換目標：control_logic_ls300d_2.c
 * - 部署方式：手動改名為 control_logic_ls300d_2.c 後執行 ./build_kenmec.sh 編譯
 * - 版本：v01
 * - 日期：2025
 *
 * ============================================================================
 ...
 * 【與原版差異】
 * ============================================================================
 * 原版 control_logic_ls300d_2.c：
 * - 計算 P1-P3 壓力差（一次側）
 * - 使用 411xxx 硬體地址
 * - 泵速寫入：speed × 10 × 10 = mV (0-10000mV)
 *
 * 新版 control_logic_ls300d_2_m_v01.c：
 * - 計算 P4-P2 壓力差（二次側）
 ...
 * - 緊急停機邏輯
 *
 * 作者: Claude AI (基於 control_logic_ls300d_3.c 架構)
 * 日期: 2025
 * 版本: v01
 */
