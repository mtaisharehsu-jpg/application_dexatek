...
#define CONFIG_REGISTER_LIST_SIZE 23
...
static int _register_list_init(void)
{
    ...
    // 環境監測暫存器 - 露點計算
    _control_logic_register_list[17].name = REG_ENV_TEMP_STR;
    _control_logic_register_list[17].address_ptr = &REG_ENV_TEMP,
    _control_logic_register_list[17].default_address = REG_ENV_TEMP,
    _control_logic_register_list[17].type = CONTROL_LOGIC_REGISTER_READ;

    _control_logic_register_list[18].name = REG_HUMIDITY_STR;
    _control_logic_register_list[18].address_ptr = &REG_HUMIDITY,
    _control_logic_register_list[18].default_address = REG_HUMIDITY,
    _control_logic_register_list[18].type = CONTROL_LOGIC_REGISTER_READ;

    _control_logic_register_list[19].name = REG_DEW_POINT_STR;
    _control_logic_register_list[19].address_ptr = &REG_DEW_POINT,
    _control_logic_register_list[19].default_address = REG_DEW_POINT,
    _control_logic_register_list[19].type = CONTROL_LOGIC_REGISTER_READ_WRITE;

    _control_logic_register_list[20].name = REG_DP_CORRECT_STR;
    _control_logic_register_list[20].address_ptr = &REG_DP_CORRECT,
    _control_logic_register_list[20].default_address = REG_DP_CORRECT,
    _control_logic_register_list[20].type = CONTROL_LOGIC_REGISTER_READ_WRITE;

    _control_logic_register_list[21].name = REG_TEMP_FOLLOW_DEW_POINT_STR;
    _control_logic_register_list[21].address_ptr = &REG_TEMP_FOLLOW_DEW_POINT,
    _control_logic_register_list[21].default_address = REG_TEMP_FOLLOW_DEW_POINT,
    _control_logic_register_list[21].type = CONTROL_LOGIC_REGISTER_READ_WRITE;

    _control_logic_register_list[22].name = REG_AUTO_START_STOP_STR;
    _control_logic_register_list[22].address_ptr = &REG_AUTO_START_STOP,
    _control_logic_register_list[22].default_address = REG_AUTO_START_STOP,
 ...
 * 處理自動啟停功能
 *
 * 此函式檢測 REG_AUTO_START_STOP (45020) 的邊緣觸發（0→1 變化），
 * 當觸發時自動執行以下操作：
